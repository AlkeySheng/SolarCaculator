<template>
    <div class="price-calculator">
        <div class="container" style="margin-top: -20px;">
            ...
            <van-grid :border="true" :column-num="4" class="custom-grid" style="margin-top: 3px;margin-bottom: -6px;">
                ...
                <van-grid-item class="custom-grid-item">
                    <span>电缆</span>
                    <van-tag type="primary" round @click="showPriceToast('直流电缆选用PV1-F-1*4，交流电缆选用ZR-YJV22-3*95+1*50，逆变器9个，单个逆变器交流电缆用量100m')">0.2542</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>支架</span>
                    <van-tag type="primary" round @click="showPriceToast('常规彩钢瓦场景')">0.1000</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>施工（含接地、桥架等）</span>
                    <van-tag type="primary" round @click="showPriceToast('含接地、桥架等辅材，人工0.19左右，机械费0.02左右，材料费0.1左右')">0.3000</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>通讯组网及视频监控系统</span>
                    <van-tag type="primary" round @click="showPriceToast('无说明')">0.0225</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>云监控系统</span>
                    <van-tag type="primary" round @click="showPriceToast('基础功能、测点调试')">0.0333</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>清洗消防系统</span>
                    <van-tag type="primary" round @click="showPriceToast('水管')">0.0023</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>设计费</span>
                ...
                <van-grid-item class="custom-grid-item">
                    <span>荷载验算费</span>
                    <van-tag type="primary" round @click="showPriceToast('无说明')">0.0167</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>设计评审费</span>
                ...
                <van-grid-item class="custom-grid-item">
                    <span>建设管理费</span>
                    <van-tag type="primary" round @click="showPriceToast('无说明')">0.1034</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>监理费</span>
                    <van-tag type="primary" round @click="showPriceToast('无说明')">0.0323</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>结算费</span>
                    <van-tag type="primary" round @click="showPriceToast('无说明')">0.0088</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>决算费</span>
                    <van-tag type="primary" round @click="showPriceToast('无说明')">0.0131</van-tag>
                </van-grid-item>
                <van-grid-item class="custom-grid-item">
                    <span>总计</span>
            ...
            <van-cell-group title="可选配置 单瓦造价(元/W)" style="margin-bottom: 10px;padding-top: -2px;margin-top: 0px;">
                <van-cell center style="padding: 5px;">
                ...
                <van-cell style="padding: 5px;">
                    <template #right-icon>
                        <van-switch v-model="waterproofing" size="22" style="margin-right: 20px;" active-color="#07c160"
                            @change="totalPrice = null" />
                    </template>
                    <template #title>
...
export default {
    ...
    data() {
        return {
            roofArea: '10000', // 屋顶面积
            height: '15', // 屋顶高度
            installCapacity: 12000, // 装机规模
            installCapacityN: 1200,
            baseP: 1.757188878,
            lowVoltageAccess: 0.04333333,
            lowVoltageAccessMessage: '低压并网柜 400*2+200*1',
            highVoltageAccess: 1.29166666666667,
            highVoltageAccessMessage: '价格按河南地区考虑，若高压接入，需配备1600kVA变压器以及二次设备,按高压就近接入。若项目在其他区域，具体造价一事一议',
            voltageAccess: 0.04333333,   //默认低压接入
            ...
            waterproofingP: 0.458333333333333,
